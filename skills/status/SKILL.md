...
allowed-tools: Bash(CLAUDE_PLUGIN_DATA="${CLAUDE_PLUGIN_DATA}" uv run "${CLAUDE_PLUGIN_ROOT}/hooks/gate.py" *)
---

!`CLAUDE_PLUGIN_DATA="${CLAUDE_PLUGIN_DATA}" uv run "${CLAUDE_PLUGIN_ROOT}/hooks/gate.py" --status "${CLAUDE_PROJECT_DIR}"`
